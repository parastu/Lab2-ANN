function [W, rbf, train_error, test_f] = ...
    delta_rbf_3_3Part3(train, test, eta, epochs, mui, sigma, units, plotting)
...
for epoch = 1:epochs
    ...
    %Calculate error
    train_error(epoch) = mean(sum((W*rbf - train).^2));
end
